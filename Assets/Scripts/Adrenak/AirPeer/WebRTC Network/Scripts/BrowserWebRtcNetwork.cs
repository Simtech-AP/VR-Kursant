...
#pragma warning restore CS0618 // Typ lub składowa jest przestarzała
        ...
        /// </summary>
        /// <param name="websocketUrl">Url of websocket to create JSON from</param>
        /// <param name="lIceServers">List of IceServers for JSON</param>
        ...
        public void StartServer(string name)
        {
            ...
            {
                Debug.LogError("Already in server mode.");
                return;
            }
        ...
        public ConnectionId Connect(string name)
        {
            ...
            if (this.mIsServer == true)
            {
                Debug.LogError("Can't create outgoing connections while in server mode!");
