...
{
	//-------------------------------------------------------------------------
	[RequireComponent( typeof( SteamInteractable ) )]
	public class Longbow : MonoBehaviour
	{
		...
		{
			nocked = false;
			hand.HoverUnlock( GetComponent<SteamInteractable>() );
			hand.otherHand.HoverUnlock( arrowHand.GetComponent<SteamInteractable>() );
		...
		public void StartNock( ArrowHand currentArrowHand )
		{
			...
			hand.HoverLock( GetComponent<SteamInteractable>() );
			nocked = true;
