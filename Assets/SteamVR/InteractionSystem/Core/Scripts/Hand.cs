...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Hand : MonoBehaviour
    {
        ...
        public struct AttachedObject
        {
            ...
            public SteamInteractable interactable;
        ...
        private SteamInteractable _hoveringInteractable;
        ...
        //-------------------------------------------------
        public SteamInteractable hoveringInteractable
        {
        ...
        public void AttachObject(GameObject objectToAttach, GrabTypes grabbedWithType, AttachmentFlags flags = defaultAttachmentFlags, Transform attachmentOffset = null)
        {
            ...
            attachedObject.interactable = objectToAttach.GetComponent<SteamInteractable>();
        ...
        protected virtual void UpdateHovering()
        {
            ...
            SteamInteractable closestInteractable = null;
        ...
        protected virtual bool CheckHoveringForTransform(Vector3 hoverPosition, float hoverRadius, ref float closestDistance, ref SteamInteractable closestInteractable, Color debugColor)
        {
            ...
            for (int colliderIndex = 0; colliderIndex < overlappingColliders.Length; colliderIndex++)
            {
                ...
                SteamInteractable contacting = collider.GetComponentInParent<SteamInteractable>();
        ...
        /// </summary>
        public bool IsStillHovering(SteamInteractable interactable)
        {
        ...
        //-------------------------------------------------
        public void HoverLock(SteamInteractable interactable)
        {
            if (spewDebugText)
        ...
        //-------------------------------------------------
        public void HoverUnlock(SteamInteractable interactable)
        {
            if (spewDebugText)
        ...
        private void InitController()
        {
            ...
            renderModels.Clear();
            GameObject renderModelInstance = null;
